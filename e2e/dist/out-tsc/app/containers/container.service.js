...
export var ContainerService = (function () {
    function ContainerService(http) {
        ...
        this.paramRunning = '/containers/json?filters={"status":["running"]}';
        this.paramStopped = '/containers/json?filters={"status":["exited"]}';
        this.paramError = '/containers/json?filters={"status":["exited","dead","restarting","created"]}';
    ...
    ContainerService.prototype.getRestartStatus = function (res) {
        if (res.status) {
